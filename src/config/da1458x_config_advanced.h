...
/* If CFG_EXT_SLEEP or no sleep mode is selected the heap memory sizes are automaticaly configured              */
/* If CFG_DEEP_SLEEP is selected heap memory sizes are controlled by setting the values of the following        */
...
/****************************************************************************************************************/
    #define CFG_NVDS_TAG_BD_ADDRESS             {0x00, 0x00, 0x00, 0xCA, 0xEA, 0x01}
